    ...
    <aside className="extra-content">
      ...
      <div>
        <a href="https://pro.imdb.com?ref_=amzn_nav_ftr" className="nav_a">
          IMDbPro
          <span className="navFooterDescText">
            Obtén información de entretenimiento que los profesionales necesitan
          </span>
        </a>
      </div>
      <div>
      ...
      <div>
        <a href="https://www.shopbop.com" className="nav_a">
          Shopbop
          <span className="navFooterDescText">Diseñador Marcas de Moda</span>
        </a>
      </div>
      <div>
        <a href="https://www.woot.com/" className="nav_a">
          Woot!
          <span className="navFooterDescText">Descuentos y travesuras</span>
        </a>
      </div>
      <div>
      ...
      <div>
        <a href="https://blinkforhome.com/?ref=nav_footer" className="nav_a">
          Blink
          <span className="navFooterDescText">
      ...
      <div>
        <a href="https://shop.ring.com/pages/neighbors-app" className="nav_a">
          Neighbors App
          <span className="navFooterDescText">
            {" "}
